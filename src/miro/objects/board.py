...
from miro.objects.mini import MiniUserObject, MiniPictureObject, MiniUserConnectionObject
...
class BoardObject(MiroObject):
	def __init__(self, data) -> None:
		...
		self.current_user_connection = MiniUserConnectionObject(data['currentUserConnection'])
